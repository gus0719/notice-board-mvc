...
%>
    <div id = "wrapper">
        ...
        <p id = "navi">
            ...
            <span id = "rowCnt">행개수
            	<select name = "rowCnt" onchange = "reloadRowCnt()">
        ...
        <form method = "get" action = "<%=contextPath%>/ControllerBoard.do">
        ...
        <div id = "columns">
            ...
            %>
            	<a class = "select" href = "<%=contextPath%>/ControllerBoard.do?bodCtg=pageTitleList&recPerPage=<%=recPerPage%>&nowPage=<%=(nowBlock-1)*pagePerBlock%>&nowBlock=<%=nowBlock-1%>">≪</a>
            <%
            }
            %>
        	<%
        	...
        	%>
        		<a class = "select" href = "<%=contextPath%>/ControllerBoard.do?bodCtg=pageTitleList&recPerPage=<%=recPerPage%>&nowPage=<%=idx1%>&nowBlock=<%=nowBlock%>"><%=idx1+1%></a>
        	<%
